...
class AreaLinkedJsonResult(BaseModel):
    """
    ...
    items: Optional[List[AreaLinked]] = Field(default=None, alias="Items")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AreaLinkedJsonResult from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AreaLinkedJsonResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "Seed": obj.get("Seed"),
            "Items": [AreaLinked.from_dict(_item) for _item in obj.get("Items")] if obj.get("Items") is not None else None
        })
        return _obj
