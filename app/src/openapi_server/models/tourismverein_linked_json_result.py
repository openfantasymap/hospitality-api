...
class TourismvereinLinkedJsonResult(BaseModel):
    """
    ...
    items: Optional[List[TourismvereinLinked]] = Field(default=None, alias="Items")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TourismvereinLinkedJsonResult from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TourismvereinLinkedJsonResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "Seed": obj.get("Seed"),
            "Items": [TourismvereinLinked.from_dict(_item) for _item in obj.get("Items")] if obj.get("Items") is not None else None
        })
        return _obj
