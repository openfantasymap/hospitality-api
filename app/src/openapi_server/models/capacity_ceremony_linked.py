...
class CapacityCeremonyLinked(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Self", "Id", "Shortname", "MaxSeatingCapacity"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CapacityCeremonyLinked from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CapacityCeremonyLinked from a dict"""
        if obj is None:
            return None
