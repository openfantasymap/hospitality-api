...
class CategoryCodesLinked(BaseModel):
    """
    CategoryCodesLinked
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["Self", "Id", "Shortname"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CategoryCodesLinked from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CategoryCodesLinked from a dict"""
        if obj is None:
            return None
