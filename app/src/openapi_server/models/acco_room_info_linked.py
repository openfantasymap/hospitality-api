...
class AccoRoomInfoLinked(BaseModel):
    """
    AccoRoomInfoLinked
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["Self", "Id", "Source"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccoRoomInfoLinked from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AccoRoomInfoLinked from a dict"""
        if obj is None:
            return None
