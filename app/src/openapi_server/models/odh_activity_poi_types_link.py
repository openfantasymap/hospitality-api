...
class ODHActivityPoiTypesLink(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Id", "Self", "Type"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ODHActivityPoiTypesLink from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ODHActivityPoiTypesLink from a dict"""
        if obj is None:
            return None
