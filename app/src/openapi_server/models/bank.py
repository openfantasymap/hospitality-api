...
class Bank(BaseModel):
    ...
    iban: Optional[StrictStr] = Field(default=None, alias="Iban")
    swift: Optional[StrictStr] = Field(default=None, alias="Swift")
    __properties: ClassVar[List[str]] = ["Name", "Iban", "Swift"]
