...
class Tags(BaseModel):
    ...
    tag_entry: Optional[Dict[str, StrictStr]] = Field(default=None, alias="TagEntry")
    __properties: ClassVar[List[str]] = ["Id", "Source", "Self", "Type", "Name", "TagEntry"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if tag_entry (nullable) is None
        # and model_fields_set contains the field
        if self.tag_entry is None and "tag_entry" in self.model_fields_set:
            _dict['TagEntry'] = None
