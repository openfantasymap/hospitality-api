...
class AdditionalArticleInfos(BaseModel):
    """
    AdditionalArticleInfos
    """ # noqa: E501
    language: Optional[StrictStr] = Field(default=None, alias="Language")
    elements: Optional[Dict[str, StrictStr]] = Field(default=None, alias="Elements")
    __properties: ClassVar[List[str]] = ["Language", "Elements"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AdditionalArticleInfos from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AdditionalArticleInfos from a dict"""
        if obj is None:
            return None
