...
class UpdateHistory(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["LastUpdate", "UpdateSource", "UpdatedBy"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UpdateHistory from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UpdateHistory from a dict"""
        if obj is None:
            return None
