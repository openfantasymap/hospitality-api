...
class BatchCRUDResult(BaseModel):
    """
    BatchCRUDResult
    """ # noqa: E501
    ...
    updated: Optional[StrictInt] = Field(default=None, alias="Updated")
    unchanged: Optional[StrictInt] = Field(default=None, alias="Unchanged")
    errors: Optional[StrictInt] = Field(default=None, alias="Errors")
    __properties: ClassVar[List[str]] = ["Success", "ErrorMessage", "TotalProcessed", "Created", "Updated", "Unchanged", "Errors"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BatchCRUDResult from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BatchCRUDResult from a dict"""
        if obj is None:
            return None
