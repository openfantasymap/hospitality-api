...
class PaymentTerm(BaseModel):
    ...
    methods: Optional[StrictInt] = Field(default=None, alias="Methods")
    prepayment: Optional[StrictInt] = Field(default=None, alias="Prepayment")
    ccards: Optional[StrictInt] = Field(default=None, alias="Ccards")
    priority: Optional[StrictInt] = Field(default=None, alias="Priority")
    description: Optional[StrictStr] = Field(default=None, alias="Description")
    bank: Optional[Bank] = Field(default=None, alias="Bank")
    __properties: ClassVar[List[str]] = ["Id", "Methods", "Prepayment", "Ccards", "Priority", "Description", "Bank"]
