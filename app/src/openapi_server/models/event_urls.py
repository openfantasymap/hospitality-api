...
class EventUrls(BaseModel):
    ...
    url: Optional[Dict[str, StrictStr]] = Field(default=None, alias="Url")
    active: Optional[StrictBool] = Field(default=None, alias="Active")
    __properties: ClassVar[List[str]] = ["Type", "Url", "Active"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EventUrls from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EventUrls from a dict"""
        if obj is None:
            return None
