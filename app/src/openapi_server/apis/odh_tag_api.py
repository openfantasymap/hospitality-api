...
from openapi_server.apis.odh_tag_api_base import BaseODHTagApi
...
@router.get(
    "/v1/ODHTag",
    responses={
        200: {"model": List[ODHTagLinked], "description": "List created"},
...
async def v1_odh_tag_get(
    ...
    validforentity: Annotated[Optional[StrictStr], Field(description="Filter on Tags valid on Entities (accommodation, activity, poi, odhactivitypoi, package, gastronomy, event, article, common .. etc..)")] = Query(None, description="Filter on Tags valid on Entities (accommodation, activity, poi, odhactivitypoi, package, gastronomy, event, article, common .. etc..)", alias="validforentity"),
    mainentity: Annotated[Optional[StrictStr], Field(description="Filter on Tags with MainEntity set to (accommodation, activity, poi, odhactivitypoi, package, gastronomy, event, article, common .. etc..)")] = Query(None, description="Filter on Tags with MainEntity set to (accommodation, activity, poi, odhactivitypoi, package, gastronomy, event, article, common .. etc..)", alias="mainentity"),
    ...
    localizationlanguage: Annotated[Optional[StrictStr], Field(description="here for Compatibility Reasons, replaced by language parameter")] = Query(None, description="here for Compatibility Reasons, replaced by language parameter", alias="localizationlanguage"),
    ...
    if not BaseODHTagApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseODHTagApi.subclasses[0]().v1_odh_tag_get(pagenumber, pagesize, language, validforentity, mainentity, displayascategory, source, publishedon, fields, searchfilter, rawfilter, rawsort, localizationlanguage, removenullvalues, getasidarray)


@router.get(
    "/v1/ODHTag/{id}",
    responses={
        200: {"model": ODHTagLinked, "description": "Object created"},
        400: {"model": ProblemDetails, "description": "Request Error"},
        500: {"description": "Internal Server Error"},
    },
    tags=["ODHTag"],
...
async def single_odh_tag(
    id: Annotated[StrictStr, Field(description="ID of the Odhtags")] = Path(..., description="ID of the Odhtags"),
    language: Annotated[Optional[StrictStr], Field(description="Language field selector, displays data and fields available in the selected language (default:'null' all languages are displayed)")] = Query(None, description="Language field selector, displays data and fields available in the selected language (default:&#39;null&#39; all languages are displayed)", alias="language"),
    fields: Annotated[Optional[List[StrictStr]], Field(description="Select fields to display, More fields are indicated by separator ',' example fields=Id,Active,Shortname (default:'null' all fields are displayed). <a href=\"https://github.com/noi-techpark/odh-docs/wiki/Common-parameters%2C-fields%2C-language%2C-searchfilter%2C-removenullvalues%2C-updatefrom#fields\" target=\"_blank\">Wiki fields</a>")] = Query(None, description="Select fields to display, More fields are indicated by separator &#39;,&#39; example fields&#x3D;Id,Active,Shortname (default:&#39;null&#39; all fields are displayed). &lt;a href&#x3D;\&quot;https://github.com/noi-techpark/odh-docs/wiki/Common-parameters%2C-fields%2C-language%2C-searchfilter%2C-removenullvalues%2C-updatefrom#fields\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Wiki fields&lt;/a&gt;", alias="fields"),
    ...
    if not BaseODHTagApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseODHTagApi.subclasses[0]().single_odh_tag(id, language, fields, localizationlanguage, removenullvalues)
