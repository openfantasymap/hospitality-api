...
from openapi_server.apis.distinct_api_base import BaseDistinctApi
...
async def v1_distinct_get(
    ...
    if not BaseDistinctApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseDistinctApi.subclasses[0]().v1_distinct_get(pagenumber, pagesize, odhtype, type, fields, seed, rawfilter, rawsort, getasarray, excludenulloremptyvalues)
