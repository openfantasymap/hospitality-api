...
from openapi_server.models.announcement import Announcement  # noqa: F401
from openapi_server.models.announcement_json_result import AnnouncementJsonResult  # noqa: F401
...
def test_v1_announcement_get(client: TestClient):
    """Test case for v1_announcement_get

    GET Announcement List
    """
    params = [("pagenumber", 1),     ("pagesize", 56),     ("language", 'language_example'),     ("langfilter", 'langfilter_example'),     ("idlist", 'idlist_example'),     ("source", 'source_example'),     ("begin", 'begin_example'),     ("end", 'end_example'),     ("tagfilter", 'tagfilter_example'),     ("seed", 'seed_example'),     ("polygon", 'polygon_example'),     ("fields", ['fields_example']),     ("searchfilter", 'searchfilter_example'),     ("rawfilter", 'rawfilter_example'),     ("rawsort", 'rawsort_example'),     ("removenullvalues", False),     ("getasidarray", False)]
    headers = {
...
def test_v1_announcement_post(client: TestClient):
    """Test case for v1_announcement_post
...
def test_single_announcement(client: TestClient):
    """Test case for single_announcement
    ...
    #response = client.request(
    #    "GET",
    #    "/v1/Announcement/{id}".format(id='id_example'),
    #    headers=headers,
    #    params=params,
    #)
...
def test_v1_announcement_id_put(client: TestClient):
    """Test case for v1_announcement_id_put
...
def test_v1_announcement_id_delete(client: TestClient):
    """Test case for v1_announcement_id_delete
